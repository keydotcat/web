...
export default{
  ...
  login (request) {
    ...
    return axios.post(rootSvc.urlRoot + '/auth/login', request, config)
      .then((response) => Promise.resolve(response.data))
      .catch((error) => Promise.reject(error))
  },
  ...
  resendConfirmEmail (request) {
    return axios.post(rootSvc.urlRoot + '/auth/request_confirmation_token', request, rootSvc.getHeaders())
      .then((response) => Promise.resolve(response.data))
      .catch((error) => Promise.reject(error))
  },
  getSession (request) {
